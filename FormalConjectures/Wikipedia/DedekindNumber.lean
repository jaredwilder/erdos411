...
def kisielewiczFormula (n : ℕ) : ℕ :=
 ...
 theorem kisielewiczFormula_zero : kisielewiczFormula 0 = 2:= by decide
 theorem kisielewiczFormula_one : kisielewiczFormula 1 = 3 := by decide
 theorem kisielewiczFormula_two : kisielewiczFormula 2 = 6 := by decide
 theorem kisielewiczFormula_three : kisielewiczFormula 3 = 20 := by
  native_decide
